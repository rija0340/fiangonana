...
-----------------------------------------------------------------*/
    ...
    var dataTest = [
        {
            title: 'All Day Event ksdjfldkjfl',
            start: "2023-01-25",
        ...
        {
            "title": "mandehaaa ahoNy Andriamanitro",
            "start": "2023-02-04",
    ...
    var calendar = new Calendar(calendarEl, {
        ...
        events: '/hira/choral/historique-data',
        editable: false,
        ...
        eventClick: function (info) {
            ...
            alert('Fotoana: ' + info.event.extendedProps.description);
